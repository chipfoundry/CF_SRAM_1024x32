...
|---|---|---|---|---|---|---|---|---|
| Pin 47 | AD[8:0] | digital | In | vpwrtp | vgnd | LV | No | Address, sampled on rising edge of CLKin |
...
| Pin 56 | vpwrtpc | digital | In | vpwrtp | vgnd | LV | Yes | Periphery Power switch control Low: power switch from vpwrtp to vpwrtp is ON (conducting) High: power switch from vpwrtp to vpwrtp is OFF (non-conducting) |
...
| Pin 59 | vpwrtp | power | Inout | vpwr | vgnd | LV | Yes | Nominal 1.8V power supply for periphery. Connection to vpwrm controlled by vpwrtpc |
| Pin 60 | vpwra | power | Inout | vpwr | vgnd | LV | Yes | Nominal 1.8V power supply for array. connection to vpwrm controlled by vpwrac |
| Pin 61 | vbb | bulk | In | vpwr | vgnd | LV | Yes | Bulk supply for Nfets |
| Pin 62 | vpp | bulk | In | vpwr | vgnd | LV | Yes | Bulk supply for Pfets |
